//
//  HistoryItemsTableViewController.swift
//  Assignment-2-iOS
//
...
class HistoryItemsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            cell.textLabel?.text = purchase.itemName
            cell.detailTextLabel?.text = "Qty: \(purchase.quantity), Date: \(dateFormatter.string(from: purchase.date)), Total: \(String(format: "%.2f", purchase.totalAmount))"
